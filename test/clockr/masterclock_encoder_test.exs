defmodule Clockr.MasterclockEncoderTest do
  ...
  test "encodes blank as appropriate control packet" do
    ...
    assert(Clockr.MasterclockEncoder.packetize({:blank, %{h: 0, m: 0, s: 0}}, 1) == result)
  end
  ...
  test "encodes dashes as appropriate control packet" do
    ...
    assert(Clockr.MasterclockEncoder.packetize({:dashes, %{h: 0, m: 0, s: 0}}, 1) == result)
  end
  ...
  test "encodes time as appropriate control packet" do
    ...
    assert(Clockr.MasterclockEncoder.packetize({:time, %{h: 0, m: 0, s: 0}}, 1) == result)
  end
  ...
  test "encodes value as appropriate control packet" do
    ...
    assert(Clockr.MasterclockEncoder.packetize({:value, %{h: 12, m: 30, s: 0}}, 0x1) == result)
  end
end
